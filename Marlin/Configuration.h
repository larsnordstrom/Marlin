...
#define CUSTOM_MACHINE_NAME "BabaBear TURBO"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like http://www.uuidgenerator.net/version4
#define MACHINE_UUID "ea771b2d-4155-4454-b4a4-6ec733909012"
...
#define PROBE_MARGIN 0

// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_FEEDRATE (7200)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (960)
...
#define HOMING_FEEDRATE_MM_M { (2700), (2700), (480) }
